...
public class DotnetFormat
{
    ...
    public void MaxLineLength(int parameter1, int parameter2, int parameter3, int parameter4, int parameter5, int parameter6)
    {
        Console.WriteLine("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa");
    }
}
