...
public class Rider
{
    // trim_trailing_whitespace: add trailing whitespaces after the Console.WriteLine, then trigger formatting
    ...
    public void MaxLineLength(int parameter1, int parameter2, int parameter3, int parameter4,
        int parameter5,
        int parameter6)
    {
        Console.WriteLine(
    ...
    public void NewLineBeforeMembersInObjectInitializers()
    {
        ...
        var b = new ClassWithFourMembers { A = 1, B = 2, C = 3 };
    ...
    public void NewLineBetweenQueryExpressionClauses()
    {
        ...
        var q1 = from a in list
            from b in list
            select a * b;

        var q2 = from aaaaaaaaaaaaaaaaaa in list
