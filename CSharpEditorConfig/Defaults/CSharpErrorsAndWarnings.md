...
|CS0055|Error|Inconsistent accessibility: parameter type '{1}' is less accessible than indexer or property '{0}'|
...
|CS0206|Error|A non ref-returning property or indexer may not be used as an out or ref value|
...
|CS0225|Error|The params parameter must have a valid collection type|
|CS0226|Error|An \_\_arglist expression may only appear inside of a call or new expression|
...
|CS0267|Error|The 'partial' modifier can only appear immediately before 'class', 'record', 'struct', 'interface', 'event', an instance constructor name, or a method or property return type.|
...
|CS0401|Error|The new() constraint must be the last restrictive constraint specified|
...
|CS0601|Error|The DllImport attribute must be specified on a method marked 'extern' that is either 'static' or an extension member|
...
|CS0674|Error|Do not use 'System.ParamArrayAttribute'/'System.Runtime.CompilerServices.ParamCollectionAttribute'. Use the 'params' keyword instead.|
...
|CS0750|Error|A partial member cannot have the 'abstract' modifier|
|CS0751|Error|A partial member must be declared within a partial type|
|CS0754|Error|A partial member may not explicitly implement an interface member|
...
|CS0758|Error|Both partial member declarations must use a params parameter or neither may use a params parameter|
...
|CS0763|Error|Both partial member declarations must be static or neither may be static|
|CS0764|Error|Both partial member declarations must be unsafe or neither may be unsafe|
...
|CS1103|Error|The receiver parameter of an extension cannot be of type '{0}'|
...
|CS1110|Error|Cannot define a new extension because the compiler required type '{0}' cannot be found. Are you missing a reference to System.Core.dll?|
...
|CS1519|Error|Invalid token '{0}' in a member declaration|
...
|CS1637|Error|Iterators cannot have pointer type parameters|
...
|CS1674|Error|'{0}': type used in a using statement must implement 'System.IDisposable'.|
...
|CS1751|Error|Cannot specify a default value for a parameter collection|
...
|CS1997|Error|Since '{0}' is an async method that returns '{1}', a return keyword must not be followed by an object expression|
...
|CS8142|Error|Both partial member declarations, '{0}' and '{1}', must use the same tuple element names.|
...
|CS8178|Error|A reference returned by a call to '{0}' cannot be preserved across 'await' or 'yield' boundary.|
...
|CS8331|Error|Cannot assign to {0} '{1}' or use it as the right hand side of a ref assignment because it is a readonly variable|
|CS8332|Error|Cannot assign to a member of {0} '{1}' or use it as the right hand side of a ref assignment because it is a readonly variable|
...
|CS8338|Error|The first 'in' or 'ref readonly' parameter of the extension method '{0}' must be a concrete (non-generic) value type.|
...
|CS8358|Error|Cannot use attribute constructor '{0}' because it has 'in' or 'ref readonly' parameters.|
...
|CS8410|Error|'{0}': type used in an asynchronous using statement must implement 'System.IAsyncDisposable' or implement a suitable 'DisposeAsync' method.|
...
|CS8618|Warning|Non-nullable {0} '{1}' must contain a non-null value when exiting constructor. Consider adding the 'required' modifier or declaring the {0} as nullable.|
...
|CS8663|Error|Both partial member declarations must be readonly or neither may be readonly|
...
|CS8799|Error|Both partial member declarations must have identical accessibility modifiers.|
|CS8800|Error|Both partial member declarations must have identical combinations of 'virtual', 'override', 'sealed', and 'new' modifiers.|
...
|CS8818|Error|Partial member declarations must have matching ref return values.|
...
|CS8862|Error|A constructor declared in a type with parameter list must have 'this' constructor initializer.|
|CS8863|Error|Only a single partial type declaration may have a parameter list|
...
|CS8944|Error|'{0}' is not an instance method, the receiver or extension receiver parameter cannot be an interpolated string handler argument.|
...
|CS8982|Error|A constructor declared in a 'struct' with parameter list must have a 'this' initializer that calls the primary constructor or an explicitly declared constructor.|
...
|CS8988|Error|The 'scoped' modifier of parameter '{0}' doesn't match partial definition.|
...
|CS9072|Error|A deconstruction variable cannot be declared as a ref local|
...
|CS9085|Warning|This ref-assigns '{1}' to '{0}' but '{1}' has a narrower escape scope than '{0}'.|
|CS9086|Warning|The branches of the ref conditional operator refer to variables with incompatible declaration scopes|
|CS9087|Warning|This returns a parameter by reference '{0}' but it is not a ref parameter|
|CS9088|Warning|This returns a parameter by reference '{0}' but it is scoped to the current method|
|CS9089|Warning|This returns by reference a member of parameter '{0}' that is not a ref or out parameter|
|CS9090|Warning|This returns by reference a member of parameter '{0}' that is scoped to the current method|
|CS9091|Warning|This returns local '{0}' by reference but it is not a ref local|
|CS9092|Warning|This returns a member of local '{0}' by reference but it is not a ref local|
|CS9093|Warning|This ref-assigns '{1}' to '{0}' but '{1}' can only escape the current method through a return statement.|
|CS9094|Warning|This returns a parameter by reference '{0}' through a ref parameter; but it can only safely be returned in a return statement|
|CS9095|Warning|This returns by reference a member of parameter '{0}' through a ref parameter; but it can only safely be returned in a return statement|
|CS9096|Error|Cannot ref-assign '{1}' to '{0}' because '{1}' has a wider value escape scope than '{0}' allowing assignment through '{0}' of values with narrower escape scopes than '{1}'.|
|CS9097|Warning|This ref-assigns '{1}' to '{0}' but '{1}' has a wider value escape scope than '{0}' allowing assignment through '{0}' of values with narrower escape scopes than '{1}'.|
|CS9098|Error|Implicitly typed lambda parameter '{0}' cannot have a default value.|
|CS9099|Warning|Parameter {0} has default value '{1:10}' in lambda but '{2:10}' in the target delegate type.|
|CS9100|Warning|Parameter {0} has params modifier in lambda but not in target delegate type.|
|CS9101|Error|UnscopedRefAttribute can only be applied to struct or virtual interface instance methods and properties, and cannot be applied to constructors or init-only members.|
|CS9102|Error|UnscopedRefAttribute cannot be applied to an interface implementation because implemented member '{0}' doesn't have this attribute.|
|CS9103|Error|'{0}' is defined in a module with an unrecognized RefSafetyRulesAttribute version, expecting '11'.|
|CS9105|Error|Cannot use primary constructor parameter '{0}' in this context.|
|CS9106|Error|Identifier '{0}' is ambiguous between type '{1}' and parameter '{2}' in this context.|
|CS9107|Warning|Parameter '{0}' is captured into the state of the enclosing type and its value is also passed to the base constructor. The value might be captured by the base class as well.|
|CS9108|Error|Cannot use parameter '{0}' that has ref-like type inside an anonymous method, lambda expression, query expression, or local function|
|CS9109|Error|Cannot use ref, out, or in primary constructor parameter '{0}' inside an instance member|
|CS9110|Error|Cannot use primary constructor parameter '{0}' that has ref-like type inside an instance member|
|CS9111|Error|Anonymous methods, lambda expressions, query expressions, and local functions inside an instance member of a struct cannot access primary constructor parameter|
|CS9112|Error|Anonymous methods, lambda expressions, query expressions, and local functions inside a struct cannot access primary constructor parameter also used inside an instance member|
|CS9113|Warning|Parameter '{0}' is unread.|
|CS9114|Error|A primary constructor parameter of a readonly type cannot be assigned to (except in init-only setter of the type or a variable initializer)|
|CS9115|Error|A primary constructor parameter of a readonly type cannot be returned by writable reference|
|CS9116|Error|A primary constructor parameter of a readonly type cannot be used as a ref or out value (except in init-only setter of the type or a variable initializer)|
|CS9117|Error|Members of primary constructor parameter '{0}' of a readonly type cannot be modified (except in init-only setter of the type or a variable initializer)|
|CS9118|Error|Members of primary constructor parameter '{0}' of a readonly type cannot be returned by writable reference|
|CS9119|Error|Members of primary constructor parameter '{0}' of a readonly type cannot be used as a ref or out value (except in init-only setter of the type or a variable initializer)|
|CS9120|Error|Cannot return primary constructor parameter '{0}' by reference.|
|CS9121|Error|Struct primary constructor parameter '{0}' of type '{1}' causes a cycle in the struct layout|
|CS9122|Error|Unexpected parameter list.|
|CS9123|Warning|The '&' operator should not be used on parameters or local variables in async methods.|
|CS9124|Warning|Parameter '{0}' is captured into the state of the enclosing type and its value is also used to initialize a field, property, or event.|
|CS9125|Warning|Attribute parameter 'SizeConst' must be specified.|
|CS9130|Error|Using alias cannot be a 'ref' type.|
|CS9131|Error|Only a 'using static' or 'using alias' can be 'unsafe'.|
|CS9132|Error|Using alias cannot be a nullable reference type.|
|CS9133|Error|'static' modifier must precede 'unsafe' modifier.|
|CS9134|Error|A switch expression arm does not begin with a 'case' keyword.|
|CS9135|Error|A constant value of type '{0}' is expected|
|CS9136|Error|Cannot use primary constructor parameter of type '{0}' inside an instance member|
|CS9137|Error|The 'interceptors' feature is not enabled in this namespace. Add '{0}' to your project.|
|CS9138|Error|Method '{0}' cannot be used as an interceptor because its containing type has type parameters.|
|CS9139|Error|Cannot intercept: compilation does not contain a file with path '{0}'.|
|CS9140|Error|Cannot intercept: compilation does not contain a file with path '{0}'. Did you mean to use path '{1}'?|
|CS9141|Error|The provided line and character number does not refer to an interceptable method name, but rather to token '{0}'.|
|CS9142|Error|The given file has '{0}' lines, which is fewer than the provided line number '{1}'.|
|CS9143|Error|The given line is '{0}' characters long, which is fewer than the provided character number '{1}'.|
|CS9144|Error|Cannot intercept method '{0}' with interceptor '{1}' because the signatures do not match.|
|CS9146|Error|An interceptor method must be an ordinary member method.|
|CS9147|Error|The provided line and character number does not refer to the start of token '{0}'. Did you mean to use line '{1}' and character '{2}'?|
|CS9148|Error|Interceptor must have a 'this' parameter matching parameter '{0}' on '{1}'.|
|CS9149|Error|Interceptor must not have a 'this' parameter because '{0}' does not have a 'this' parameter.|
|CS9150|Error|Interceptor cannot have a 'null' file path.|
|CS9151|Error|Possible method name '{0}' cannot be intercepted because it is not being invoked.|
|CS9152|Error|Cannot intercept a call in file with path '{0}' because multiple files in the compilation have this path.|
|CS9153|Error|The indicated call is intercepted multiple times.|
|CS9154|Warning|Intercepting a call to '{0}' with interceptor '{1}', but the signatures do not match.|
|CS9155|Error|Cannot intercept call with '{0}' because it is not accessible within '{1}'.|
|CS9156|Error|Cannot intercept call to '{0}' with '{1}' because of a difference in 'scoped' modifiers or '[UnscopedRef]' attributes.|
|CS9157|Error|Line and character numbers provided to InterceptsLocationAttribute must be positive.|
|CS9158|Warning|Nullability of reference types in return type doesn't match interceptable method '{0}'.|
|CS9159|Warning|Nullability of reference types in type of parameter '{0}' doesn't match interceptable method '{1}'.|
|CS9160|Error|A nameof operator cannot be intercepted.|
|CS9161|Error|An interceptor cannot be marked with 'UnmanagedCallersOnlyAttribute'.|
|CS9162|Error|'{0}' type is not valid for 'using static'. Only a class, struct, interface, enum, delegate, or namespace can be used.|
|CS9163|Error|'{0}' is defined in assembly '{1}'.|
|CS9164|Error|Cannot convert expression to '{0}' because it is not an assignable variable|
|CS9165|Error|Cannot convert expression to '{0}' because it may not be passed or returned by reference|
|CS9166|Error|Index is outside the bounds of the inline array|
|CS9167|Error|Inline array length must be greater than 0.|
|CS9168|Error|Inline array struct must not have explicit layout.|
|CS9169|Error|Inline array struct must declare one and only one instance field.|
|CS9170|Error|An expression tree may not contain an inline array access or conversion|
|CS9171|Error|Target runtime doesn't support inline array types.|
|CS9172|Error|Elements of an inline array type can be accessed only with a single argument implicitly convertible to 'int', 'System.Index', or 'System.Range'.|
|CS9173|Error|An inline array access may not have a named argument specifier|
|CS9174|Error|Cannot initialize type '{0}' with a collection expression because the type is not constructible.|
|CS9175|Error|An expression tree may not contain a collection expression.|
|CS9176|Error|There is no target type for the collection expression.|
|CS9177|Error|Method '{0}' must be non-generic or have arity {1} to match '{2}'.|
|CS9178|Error|Method '{0}' must be non-generic to match '{1}'.|
|CS9179|Warning|Primary constructor parameter '{0}' is shadowed by a member from base.|
|CS9180|Error|Inline array element field cannot be declared as required, readonly, volatile, or as a fixed size buffer.|
|CS9181|Warning|Inline array indexer will not be used for element access expression.|
|CS9182|Warning|Inline array 'Slice' method will not be used for element access expression.|
|CS9183|Warning|Inline array conversion operator will not be used for conversion from expression of the declaring type.|
|CS9184|Warning|'Inline arrays' language feature is not supported for an inline array type that is not valid as a type argument, or has element type that is not valid as a type argument.|
|CS9185|Error|The CollectionBuilderAttribute builder type must be a non-generic class or struct.|
|CS9186|Error|The CollectionBuilderAttribute method name is invalid.|
|CS9187|Error|Could not find an accessible '{0}' method with the expected signature: a static method with a single parameter of type 'ReadOnlySpan\<{1}\>' and return type '{2}'.|
|CS9188|Error|'{0}' has a CollectionBuilderAttribute but no element type.|
|CS9189|Error|foreach statement on an inline array of type '{0}' is not supported|
|CS9190|Error|'readonly' modifier must be specified after 'ref'.|
|CS9191|Warning|The 'ref' modifier for argument {0} corresponding to 'in' parameter is equivalent to 'in'. Consider using 'in' instead.|
|CS9192|Warning|Argument {0} should be passed with 'ref' or 'in' keyword|
|CS9193|Warning|Argument {0} should be a variable because it is passed to a 'ref readonly' parameter|
|CS9194|Error|Argument {0} may not be passed with the 'ref' keyword in language version {1}. To pass 'ref' arguments to 'in' parameters, upgrade to language version {2} or greater.|
|CS9195|Warning|Argument {0} should be passed with the 'in' keyword|
|CS9196|Warning|Reference kind modifier of parameter '{0}' doesn't match the corresponding parameter '{1}' in overridden or implemented member.|
|CS9197|Warning|Reference kind modifier of parameter '{0}' doesn't match the corresponding parameter '{1}' in hidden member.|
|CS9198|Warning|Reference kind modifier of parameter '{0}' doesn't match the corresponding parameter '{1}' in target.|
|CS9199|Error|A ref readonly parameter cannot have the Out attribute.|
|CS9200|Warning|A default value is specified for 'ref readonly' parameter '{0}', but 'ref readonly' should be used only for references. Consider declaring the parameter as 'in'.|
|CS9201|Warning|Ref field '{0}' should be ref-assigned before use.|
|CS9202|Error|Feature '{0}' is not available in C# 12.0. Please use language version {1} or greater.|
|CS9203|Error|A collection expression of type '{0}' cannot be used in this context because it may be exposed outside of the current scope.|
|CS9204|Warning|'{0}' is for evaluation purposes only and is subject to change or removal in future updates. Suppress this diagnostic to proceed.|
|CS9205|Error|Expected interpolated string|
|CS9206|Error|An interceptor cannot be declared in the global namespace.|
|CS9207|Error|Cannot intercept '{0}' because it is not an invocation of an ordinary member method.|
|CS9208|Warning|Collection expression of type '{0}' may incur unexpected heap allocations. Consider explicitly creating an array, then converting to '{0}' to make the allocation explicit.|
|CS9209|Warning|Collection expression of type '{0}' may incur unexpected heap allocations due to the use of '..' spreads. Consider explicitly creating an array, then converting to '{0}' to make the allocation explicit.|
|CS9210|Error|This version of '{0}' cannot be used with collection expressions.|
...
|CS9216|Warning|A value of type 'System.Threading.Lock' converted to a different type will use likely unintended monitor-based locking in 'lock' statement.|
|CS9217|Error|A 'ref' local cannot be preserved across 'await' or 'yield' boundary.|
|CS9218|Error|'{0}' is applicable only with expanded form of non-array params collection which is not supported during dynamic dispatch.|
|CS9222|Error|Collection initializer results in an infinite chain of instantiations of collection '{0}'.|
|CS9223|Error|Creation of params collection '{0}' results in an infinite chain of invocation of constructor '{1}'.|
|CS9224|Error|Method '{0}' cannot be less visible than the member with params collection '{1}'.|
|CS9225|Error|Constructor '{0}' leaves required member '{1}' uninitialized.|
|CS9226|Error|An expression tree may not contain an expanded form of non-array params collection parameter.|
|CS9227|Error|'{0}' does not contain a definition for a suitable instance 'Add' method|
|CS9228|Error|Non-array params collection type must have an applicable constructor that can be called with no arguments.|
...
|CS9238|Error|Cannot use 'yield return' in an 'unsafe' block|
|CS9239|Error|The '&' operator cannot be used on parameters or local variables in iterator methods.|
|CS9240|Error|Target runtime doesn't support by-ref-like generics.|
|CS9241|Error|'ref struct' is already specified.|
|CS9242|Error|The 'allows' constraint clause must be the last constraint specified|
|CS9243|Error|Cannot allow ref structs for a type parameter known from other constraints to be a class|
|CS9244|Error|The type '{2}' may not be a ref struct or a type parameter allowing ref structs in order to use it as parameter '{1}' in the generic type or method '{0}'|
|CS9245|Error|'{0}' cannot implement interface member '{1}' for ref struct '{2}'.|
|CS9246|Error|A non-virtual instance interface member cannot be accessed on a type parameter that allows ref struct.|
|CS9247|Error|foreach statement cannot operate on enumerators of type '{0}' because it is a type parameter that allows ref struct and it is not known at compile time to implement IDisposable.|
|CS9248|Error|Partial property '{0}' must have an implementation part.|
|CS9249|Error|Partial property '{0}' must have a definition part.|
|CS9250|Error|A partial property may not have multiple defining declarations, and cannot be an auto-property.|
|CS9251|Error|A partial property may not have multiple implementing declarations|
|CS9252|Error|Property accessor '{0}' must be implemented because it is declared on the definition part|
|CS9253|Error|Property accessor '{0}' does not implement any accessor declared on the definition part|
|CS9254|Error|Property accessor '{0}' must be '{1}' to match the definition part|
|CS9255|Error|Both partial member declarations must have the same type.|
|CS9256|Warning|Partial member declarations '{0}' and '{1}' have signature differences.|
|CS9257|Error|Both partial property declarations must be required or neither may be required|
|CS9258|Warning|In language version {0}, the 'field' keyword binds to a synthesized backing field for the property. To avoid generating a synthesized backing field, and to refer to the existing member, use 'this.field' or '@field' instead.|
|CS9259|Error|Attribute 'System.Runtime.CompilerServices.InlineArray' cannot be applied to a record struct.|
|CS9260|Error|Feature '{0}' is not available in C# 13.0. Please use language version {1} or greater.|
|CS9261|Error|Cannot use 'OverloadResolutionPriorityAttribute' on an overriding member.|
|CS9262|Error|Cannot use 'OverloadResolutionPriorityAttribute' on this member.|
|CS9263|Error|A partial property cannot have an initializer on both the definition and implementation.|
|CS9264|Warning|Non-nullable {0} '{1}' must contain a non-null value when exiting constructor. Consider adding the 'required' modifier, or declaring the {0} as nullable, or safely handling the case where 'field' is null in the 'get' accessor.|
|CS9265|Warning|Field '{0}' is never ref-assigned to, and will always have its default value (null reference)|
|CS9266|Warning|The '{0}' accessor of property '{1}' should use 'field' because the other accessor is using it.|
|CS9267|Error|Element type of an iterator may not be a ref struct or a type parameter allowing ref structs|
...
|CS9271|Error|The type 'Microsoft.CodeAnalysis.EmbeddedAttribute' must be non-generic, internal, non-file, sealed, non-static, have a parameterless constructor, inherit from System.Attribute, and be able to be applied to any type.|
...
|CS9282|Error|This member is not allowed in an extension block|
...
|CS9295|Error|The type parameter `{0}` is not referenced by either the extension parameter or a parameter of this member|
...
|CS9309|Error|An extension member syntax is disallowed in nested position within an extension member syntax|
...
|CS9316|Error|Extension members are not allowed as an argument to 'nameof'.|
|CS9317|Error|The parameter of a unary operator must be the extended type.|
|CS9318|Error|The parameter type for ++ or -- operator must be the extended type.|
|CS9319|Error|One of the parameters of a binary operator must be the extended type.|
|CS9320|Error|The first operand of an overloaded shift operator must have the same type as the extended type|
|CS9321|Error|An extension block extending a static class cannot contain user-defined operators|
|CS9322|Error|Cannot declare instance operator for a struct unless containing extension block receiver parameter is a 'ref' parameter|
|CS9323|Error|Cannot declare instance extension operator for a type that is not known to be a struct and is not known to be a class|
|CS9324|Error|An expression tree may not contain '&&' or '||' operators that use extension user defined operators.|
|CS9325|Error|Interpolated string handler arguments are not allowed in this context.|
|CS9326|Error|'{0}': extension member names cannot be the same as their extended type|
|CS9327|Error|Feature '{0}' is not available in C# 14.0. Please use language version {1} or greater.|
|CS9328|Error|Method '{0}' uses a feature that is not supported by runtime async currently. Opt the method out of runtime async by attributing it with 'System.Runtime.CompilerServices.RuntimeAsyncMethodGenerationAttribute(false)'.|
|CS9329|Error|This extension block collides with another extension block. They result in conflicting content-based type names in metadata, so must be in separate enclosing static classes.|
|CS9330|Error|'MethodImplAttribute.Async' cannot be manually applied to methods. Mark the method 'async'.|
|CS9331|Error|'{0}' cannot be applied manually.|
|CS9332|Error|Cannot use '..' spread operator in the filter expression of a catch clause|
|CS9333|Error|'{0}': type must be '{1}' to match implemented member '{2}'|
|CS9334|Error|'{0}': return type must be '{1}' to match implemented member '{2}'|
